...
public class FordMustangTest {
    ...
    public void needsOilChangeAfterTravel() {
        // Arrange
        fordMustang.transport(50000.0);
        // Act
        Boolean needsOilAfter50kMiles = fordMustang.needsOilChange();
        // Assert
    ...
    public void needsOilChangeAfterOilChangeThenTravel49kMiles() {
        // Arrange
        fordMustang.transport(51000.0);
        // Act
        fordMustang.changeOil();
        fordMustang.transport(49000.0);
    ...
    public void needsOilChangeAfterOilChangeThenTravel50kMiles() {
        ...
        fordMustang.changeOil();
        fordMustang.transport(50000.0);
        Boolean oilNeedsChanging50kMiles = fordMustang.needsOilChange();
    ...
    public void transport() {
        ...
        // Act
        Integer actual = fordMustang.transport(70.0 * 2);
